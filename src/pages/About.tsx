        ...
        <div className="container-coco">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="rounded-[2rem] overflow-hidden shadow-xl shadow-coco-green/10 aspect-[4/3]">
                <img
      ...
      <section className="section-padding bg-coco-cream">
        <div className="container-coco">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Vision */}
            <div className="rounded-3xl bg-white p-8 md:p-10 shadow-sm border border-coco-green/8">
              <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-coco-green/8 text-coco-green mb-6">
            ...
            {/* Mission */}
            <div className="rounded-3xl bg-white p-8 md:p-10 shadow-sm border border-coco-green/8">
              <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-accent-gold/12 text-accent-gold mb-6">
        ...
        <div className="container-coco relative z-10">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl bg-coco-deep/40 border border-coco-cream/10 p-7 transition-all duration-500 hover:bg-coco-deep/60 hover:border-accent-gold/30 animate-fade-in-up"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent-gold/15 text-accent-gold mb-5">
              ...
              <div className="mt-6 space-y-5">
                {[
                  ...
                  <div
                    ...
                    style={{ animationDelay: `${i * 0.1}s` }}
                  >
                    <span className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-coco-green/8 text-coco-green">
