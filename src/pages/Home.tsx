          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 hidden md:block rounded-2xl bg-coco-green px-6 py-5 shadow-xl shadow-coco-green/20">
                <div className="font-display text-4xl font-extrabold text-coco-cream">15+</div>
        ...
        <div className="container-coco relative z-10">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.step}
                className="group relative rounded-2xl bg-coco-deep/40 border border-coco-cream/10 p-7 transition-all duration-500 hover:bg-coco-deep/60 hover:border-accent-gold/30 animate-fade-in-up"
        ...
        <div className="container-coco">
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl border border-coco-green/8 p-8 transition-all duration-500 hover:shadow-xl hover:shadow-coco-green/5 hover:border-coco-green/15 animate-fade-in-up"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-coco-green/8 text-coco-green mb-5">
